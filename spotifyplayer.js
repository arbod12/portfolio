...
(function(){
  ...
  + '#absp-search{padding:11px 12px 0}'
  + '#absp-search .srow{display:flex;gap:6px}'
  + '#absp-search input{flex:1;min-width:0;font-family:inherit;font-size:12px;padding:10px 11px;'
  + 'border:2px solid #1a1a1a;background:#fff;color:#15130f;border-radius:0}'
  + '#absp-search input:focus{outline:none;border-color:#1db954}'
  + '#absp-search button{background:#1db954;color:#04140a;border:2px solid #1a1a1a;cursor:pointer;'
  + 'font-size:14px;padding:0 13px;box-shadow:2px 2px 0 rgba(26,26,26,.4)}'
  + '#absp-search button:hover{transform:translate(1px,1px);box-shadow:1px 1px 0 rgba(26,26,26,.4)}'
  + '#absp-search .shint{font-size:9.5px;color:#7a756a;margin-top:5px;letter-spacing:.02em}'
  ...
  box.innerHTML =
    ...
    +   '<div id="absp-search">'
    +     '<div class="srow">'
    +       '<input id="absp-q" type="text" placeholder="Search any song, artist, or album..." aria-label="Search Spotify">'
    +       '<button id="absp-go" type="button" aria-label="Search Spotify">&#128269;</button>'
    +     '</div>'
    +     '<div class="shint">Find anything on Spotify &middot; opens in Spotify to play</div>'
    +   '</div>'
    +   '<div id="absp-moods">'
    ...
    +   '<div id="absp-find">'
    +     '<div class="lbl">Or paste a Spotify link to play it here</div>'
    +     '<div class="row">'
